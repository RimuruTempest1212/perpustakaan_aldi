    ...
    <div class="container">
        ...
        <div class="row trend_2 mt-4">
            ...
            <div id="carouselExampleCaptions2" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
				<?php foreach (array_chunk($going, 4) as $index => $chunk) : ?>
                    <div class="carousel-item <?= $index === 0 ? 'active' : '' ?>">
                        <div class="trend_2i row">
						<?php foreach ($chunk as $item) : ?>
                            <div class="col-md-4">
                                <div class="trend_2im clearfix position-relative">
                                    <div class="trend_2im1 clearfix">
                                        <div class="grid">
                                            <figure class="effect-jazz mb-0">
											<a href="#"><img src="<?= base_url() . './going/' . $item->image ?>" class="w-100" alt="img25"></a>
                                            </figure>
                                        </div>
                                    </div>
                                    <div class="trend_2im2 clearfix text-center position-absolute w-100 top-0">
                                ...
                                <div class="trend_2ilast bg_grey p-3 clearfix">
                                    <h5><a class="col_red" href="#">Judul : <?= $item->judul ?></a></h5>
                                    <p class="mb-2"><span class="col_red">Sinopsis :</span> <?= $item->sinopsis ?></p>
									<h5><span class="col_red">author :</span> <?= $item->author ?></h5>
									<h6><span class="col_red">Rilis : </span><?= date('d F Y', $item->rilis) ?></h6>
                                    <!-- <span class="col_red">
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
